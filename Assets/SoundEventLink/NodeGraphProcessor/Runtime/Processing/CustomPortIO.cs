...
namespace GraphProcessor
{
	...
	public static class CustomPortIO
	{
		...
		private static readonly Dictionary<Type, List<Type>> assignableTypes = new Dictionary<Type, List<Type>>();
		private static readonly PortIOPerNode customIOPortMethods = new PortIOPerNode();
