...
namespace GraphProcessor
{
	public static class NodeProvider
	{
		...
		private static readonly Dictionary<Type, MonoScript> nodeViewScripts = new Dictionary<Type, MonoScript>();
		private static readonly Dictionary<Type, MonoScript> nodeScripts = new Dictionary<Type, MonoScript>();
		private static readonly Dictionary<Type, Type> nodeViewPerType = new Dictionary<Type, Type>();

		private static readonly Dictionary<BaseGraph, NodeDescriptions> specificNodeDescriptions = new Dictionary<BaseGraph, NodeDescriptions>();
		private static readonly List<NodeSpecificToGraph> specificNodes = new List<NodeSpecificToGraph>();

		private static readonly NodeDescriptions genericNodes = new NodeDescriptions();
