...
namespace GraphProcessor
{
	public static class FieldFactory
	{
		...
		public static INotifyValueChanged<T> CreateField<T>(T value, string label = null) => CreateField(value != null ? value.GetType() : typeof(T), label) as INotifyValueChanged<T>;
