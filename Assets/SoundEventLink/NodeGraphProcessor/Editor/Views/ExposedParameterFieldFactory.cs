...
namespace GraphProcessor
{
	...
	{
		[SerializeField]
		private readonly ExposedParameterWorkaround exposedParameterObject;
		private readonly BaseGraph graph;
		private readonly Dictionary<ExposedParameter, ExposedParameter.Settings> oldParameterSettings = new Dictionary<ExposedParameter, ExposedParameter.Settings>();

		private readonly Dictionary<ExposedParameter, object> oldParameterValues = new Dictionary<ExposedParameter, object>();
