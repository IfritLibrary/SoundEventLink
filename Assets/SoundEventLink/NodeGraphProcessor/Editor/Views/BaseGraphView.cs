...
namespace GraphProcessor
{
	...
	public class BaseGraphView : GraphView, IDisposable
	{
		...
		private readonly Dictionary<Type, (Type nodeType, MethodInfo initalizeNodeFromObject)> nodeTypePerCreateAssetType = new Dictionary<Type, (Type, MethodInfo)>();

		private readonly Dictionary<Type, PinnedElementView> pinnedElements = new Dictionary<Type, PinnedElementView>();
