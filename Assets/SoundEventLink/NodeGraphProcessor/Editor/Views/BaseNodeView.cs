...
namespace GraphProcessor
{
	...
	public class BaseNodeView : NodeView
	{
		...
		[NonSerialized]
		private readonly List<IconBadge> badges = new List<IconBadge>();
	...
	#region API
		...
		public static Rect GetNodeRect(Node node, float left = int.MaxValue, float top = int.MaxValue) => new Rect(
	...
	#region Callbacks & Overrides
		...
		private readonly Dictionary<string, List<(object value, VisualElement target)>> visibleConditions = new Dictionary<string, List<(object value, VisualElement target)>>();
		private readonly Dictionary<string, VisualElement> hideElementIfConnected = new Dictionary<string, VisualElement>();
		private readonly Dictionary<FieldInfo, List<VisualElement>> fieldControlsMap = new Dictionary<FieldInfo, List<VisualElement>>();
