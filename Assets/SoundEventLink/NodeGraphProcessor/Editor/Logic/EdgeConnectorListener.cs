...
namespace GraphProcessor
{
	...
	public class BaseEdgeConnectorListener : IEdgeConnectorListener
	{
		...
		private readonly Dictionary<Edge, PortView> edgeInputPorts = new Dictionary<Edge, PortView>();
		private readonly Dictionary<Edge, PortView> edgeOutputPorts = new Dictionary<Edge, PortView>();
